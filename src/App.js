...
function App() {
  ...
  return (
        ...
        <nav className='navbar '>
          <div>
            <button onClick={()=> setOpenFeatures(!openFeatures)} className='flex items-center justify-start'>
              Features {openFeatures? <img src={chevronUp}alt="" className='ml-2' /> :<img src={chevronDown}alt="" className='ml-2'/>}</button>
              {openFeatures &&  <ul className='mt-2 ml-3 lg:ml-0 lg:p-3 lg:shadow '>
              <li className='flex items-center justify-start text-sm mb-2'><img src={todolist}className="mr-2"  alt=""/>Todo list </li>
              <li className='flex items-center justify-start text-sm mb-2'><img src={calender} className="mr-2" alt=""/>Caleander</li>
              <li className='flex items-center justify-start text-sm mb-2'><img src={reminders}className="mr-2"  alt=""/>Reminders</li>
              <li className='flex items-center justify-start text-sm mb-2'><img src={planning} className="mr-2" alt=""/>Planning</li>
            </ul>}
            </div>
          <div><button onClick={()=> setOpenCompany(!openCompany)} className='flex items-center justify-start'>Company  {openCompany? <img src={chevronUp}alt="" className='ml-2' /> :<img src={chevronDown}alt="" className='ml-2'/>}</button>
          ...
          <div className='mb-2 lg:mb-0'><button className=''>Careers</button></div>
          <div><button>About</button></div>
        </nav>
      </div>
      <div className='lg:hidden'>
        <button onClick={handleOpenMenu}>
           <img src={menuOpen} className="menu-button " alt=""/>
        </button>
        </div>
    ...
    <section className='flxe flex-col-reverse py-20 md:grid  md:gap-10 md:grid-cols-2 md:place-items-center max-w-4xl lg:max-w-5xl md:mx-auto'>
      <article className='text-center md:text-left px-5 xl:px-0 mt-10 md:mt-0'>
        <h1 className='font-bold text-4xl lg:text-6xl xl:text-7xl mb-5'>Make remot work </h1>
